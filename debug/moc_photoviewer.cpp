...
#include "../../untitled1/photoviewer.h"
...
QT_MOC_LITERAL(4, 31, 17) // "handleButtonClick"

    },
    "PhotoViewer\0photoClicked\0\0path\0"
    "handleButtonClick"
};
...
void PhotoViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PhotoViewer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->photoClicked((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (PhotoViewer::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject PhotoViewer::staticMetaObject = { {
    ...
    qt_meta_stringdata_PhotoViewer.data,
    qt_meta_data_PhotoViewer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void PhotoViewer::photoClicked(const QString & _t1)
{
